...
#' @examples
#'
density_plot_for_pol2 <- function(Pol2_dat, outfile, background_value){
          ...
          #--- plot ggplot
          gg = ggplot(ppm,aes(value+0.01,fill=variable))+geom_density(alpha=0.5)+xlab("Pol2 Occupancy Value")+theme_bw()+
                    ...
                    guides(fill = guide_legend(title=""))+labs(x="RNA Pol II occupancy", y="Density")
